      ...
      <div className="flex-1 px-6 pt-10">
        <form onSubmit={handleSubmit} autoComplete="on" className="space-y-4">
          <div className="space-y-1.5">
            <label htmlFor="login-identifier" className="text-sm font-semibold text-[#4A4435]">Email / ID Karyawan</label>
            <input
              id="login-identifier"
              type="text"
              name="username"
          ...
          <div className="space-y-1.5">
            <label htmlFor="login-password" className="text-sm font-semibold text-[#4A4435]">Kata Sandi</label>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm text-[#8C8573]">Ingat saya di perangkat ini</span>
            </label>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full rounded-2xl bg-[#FACC15] text-[#4A4435] font-bold text-base flex items-center justify-center gap-2 shadow-md disabled:opacity-60 active:scale-[0.98] transition-transform"
            style={{ height: "52px" }}
          >
